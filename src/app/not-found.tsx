          ...
          {services.map((service) => (
            <li key={service.slug}>
              <Link
                ...
                className="inline-block rounded-full border border-line bg-surface px-4 py-2 font-display text-[0.9rem] tracking-tight text-body transition-colors hover:border-cobalt-lift hover:text-cobalt-lift"
              >
                {service.short}
              </Link>
            </li>
